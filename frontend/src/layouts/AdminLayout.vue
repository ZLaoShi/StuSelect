    ...
    >
      <div class="layout-sider-header">
        <div v-if="!collapsed" class="logo-full">
          ...
          <div class="logo-text">选课管理系统</div>
        </div>
    ...
    <n-layout :style="{ marginLeft: collapsed ? '64px' : '240px' }">
      ...
      <n-layout-footer bordered>
        <div class="layout-footer-wrapper">
          <p class="footer-text">© {{ currentYear }} 学生选课系统 - 管理端 - 版权所有</p>
        </div>
      </n-layout-footer>
    </n-layout>
  </n-layout>
...
const activeKey = computed(() => {
  ...
  if (path.includes('/dashboard')) return 'dashboard'
    ...
    if (path.includes('/courses/')) return 'courses_detail'
    return 'courses'
  }
  return 'dashboard'
})
